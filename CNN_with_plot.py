...
class AirbnbPreprocessorAndTrainer:
    ...
    def show_images(self, loader, title="Beispielbilder"):
        """Zeigt eine Batch von Bildern aus dem DataLoader"""
        dataiter = iter(loader)
        ((images, _), _) = next(dataiter)
        
        # Konvertiere Tensor zu numpy für die Darstellung
        images = images.cpu()
    ...
    def train_model(self, epochs=50):
        ...
        model = self.CNNPricePredictor(tab_dim).to(self.device)
...
if __name__ == "__main__":
    ...
    # Zeige Beispielbilder vor dem Training
    print("\nZeige Beispielbilder aus dem Trainingsdatensatz:")
    trainer.show_images(trainer.train_loader, "Beispielbilder aus dem Trainingsdatensatz")
